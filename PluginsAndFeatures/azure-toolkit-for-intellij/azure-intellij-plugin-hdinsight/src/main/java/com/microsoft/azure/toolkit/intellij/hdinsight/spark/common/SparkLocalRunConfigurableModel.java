...
package com.microsoft.azure.toolkit.intellij.hdinsight.spark.common;
...
public class SparkLocalRunConfigurableModel implements CommonJavaRunConfigurationParameters, ILogger {
    ...
    public SparkLocalRunConfigurableModel(@NotNull Project project) {
        ...
        if (SystemUtils.IS_OS_WINDOWS) {
            try {
                Optional.ofNullable(System.getenv(SparkLocalRunParamsPanel.HADOOP_HOME_ENV))
                        ...
                        .ifPresent(hadoopHome -> this.envs.put(SparkLocalRunParamsPanel.HADOOP_HOME_ENV, hadoopHome));
            } catch (Exception ex) {
